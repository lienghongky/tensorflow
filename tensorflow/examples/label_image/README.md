...
label_image.py is a python implementation that 
provides code correspoding to the C++ code. This provides more 
intuitive mapping between C++ and Python than the code mentioned in 
the [image recoginition 
